#!/bin/bash
# SWEEP S14-MS part 4/6 — Anchor C (d1e-6 cc0.035 cdc0.0) coupled diagonal
...
run_s14_cell() {
    ...
    echo "----------------------------------------------------------------"
    echo "[S14-MS-4 ${CELL}/${TOTAL}] ${RUN_NAME}"
