...
if USE_WANDB:
    #wandb.init(entity= "daniel-y-sprague-harvard-university", project="vnl-mjx-rl", config=env_cfg, id=f"intention-rear-{exp_name}")
    wandb.init(entity= "daniel-y-sprague-harvard-university", project="vnl-mjx-rl", config=env_cfg, id=f"intention-flat-arena-{exp_name}")
    wandb.config.update(
        {
            "env_name": env_name,
        }
