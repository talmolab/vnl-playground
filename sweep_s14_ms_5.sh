#!/bin/bash
# SWEEP S14-MS part 5/6 — Anchor C (d1e-6 cc0.035 cdc0.0) low-t asymmetric + L0 + F1
...
run_s14_cell() {
    ...
    echo "----------------------------------------------------------------"
    echo "[S14-MS-5 ${CELL}/${TOTAL}] ${RUN_NAME}"
