#!/bin/bash
# SWEEP S14-MS part 3/6 — Anchor A (d9e-7 cc0.025 cdc0.025) asymmetric core
...
run_s14_cell() {
    ...
    echo "----------------------------------------------------------------"
    echo "[S14-MS-3 ${CELL}/${TOTAL}] ${RUN_NAME}"
